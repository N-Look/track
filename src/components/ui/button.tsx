  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-[var(--glass-border)] bg-[var(--glass-bg-light)] shadow-sm hover:bg-[var(--glass-bg)]",
        secondary:
          "bg-[var(--glass-bg)] border border-[var(--glass-border-subtle)] text-secondary-foreground shadow-sm hover:bg-[var(--glass-bg-heavy)]",
        ghost:
      ...
      size: {
        ...
        xs: "h-8 md:h-6 gap-1 rounded-lg px-2 text-xs has-[>svg]:px-1.5 [&_svg:not([class*='size-'])]:size-3",
        sm: "h-10 md:h-8 rounded-lg gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "h-12 md:h-10 rounded-lg px-6 has-[>svg]:px-4",
        icon: "size-11 md:size-9",
        "icon-xs": "size-8 md:size-6 rounded-lg [&_svg:not([class*='size-'])]:size-3",
